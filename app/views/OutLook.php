                            ...
                            <!--single form panel-->
                                <div class="multisteps-form__panel  js-active" data-animation="scaleIn">
                                    ...
                                    <div class="button-row d-flex mt-4">
                                        <button class="js-btn-next js-btn-next pull-right btn-scroll width-50 ml-auto" type="button" title="Next">Next</button>
                                    </div>
                                </div>
                                <!--single form panel-->
                                <div class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn">
                                    <div class="element">
                                        ...
                                        <div class="button-row mt-4">
                                            <button  onclick="validateUsername()" class="btn-scroll pull-right" title="Sign in" type="submit">Sign in</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
